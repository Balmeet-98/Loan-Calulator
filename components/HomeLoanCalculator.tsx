...
import { Home, DollarSign, TrendingUp, Calendar, Building } from 'lucide-react'
import { 
  calculateHomeLoan, 
  formatCurrency, 
  formatPercentage,
...
export default function HomeLoanCalculator() {
  ...
  useEffect(() => {
    ...
    if (validation.isValid) {
      const result = calculateHomeLoan(inputs)
      setResults(result)
    }
  }, [inputs])
  ...
  const downPayment = propertyValue - inputs.principal
    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        <div className="flex items-center justify-center space-x-2 mb-4">
          ...
          <h2 className="text-3xl font-bold text-gray-900">Home Loan Calculator</h2>
        </div>
        <p className="text-gray-600 max-w-2xl mx-auto">
          Calculate your home loan EMI with processing fees and down payment options. 
          Plan your dream home purchase with accurate calculations.
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <div className="bg-gray-50 rounded-xl p-6">
            <h3 className="text-xl font-semibold text-gray-900 mb-6">Property & Loan Details</h3>
            ...
            <div className="bg-blue-50 rounded-lg p-4 mb-6">
              <h4 className="font-semibold text-blue-900 mb-2">Down Payment Summary</h4>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-blue-700">Down Payment Amount:</span>
                  <span className="font-semibold text-blue-900">{formatCurrency(downPayment)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-blue-700">Down Payment %:</span>
                  <span className="font-semibold text-blue-900">{downPaymentPercentage.toFixed(1)}%</span>
                </div>
              </div>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Home Loan Summary</h3>
            <div className="space-y-3">
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-blue-600">{formatCurrency(downPayment)}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="border-t pt-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-green-600">{formatCurrency(results.emi)}</span>
                </div>
                <div className="flex justify-between">
